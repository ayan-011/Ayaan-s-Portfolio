...
export function Status(){
     return(
        <>
          <div className="status w-full  border-b-[1px] border-[#525252] bg-red-90 text-zinc-300 flex flex-row justify-between px-2 py-">
          ...
          <div className="files flex flex-col px-3 leading-5 mb- ">
