...
function App() {
  ...
  return (
    <div className="relative min-h-screen select-none">
      <div className="absolute inset-0 bg-[url('/noise.gif')] opacity-5 pointer-events-none  z-999" />
      ...
      <div className=" z-20 relative   bg-red-9 min-h-screen bg- flex flex-col justify-center items-center lg:px-4     overflow-x-hidden ">
        ...
        {/* Main  */}
        <div
          className=" w-full max-w-6xl grid sm:gap-3 gap-1 bg-red-90 p-3    
        ...
        >
          ...
          <div className="col-span-2 sm:col-span-2 border border-[#525252] rounded-lg lg:rounded-xl bg-[#1e1e1e] overflow-hidden overflow-y-scroll scrollbar-hide px-2 flex flex-col gap-1">
            <div className="w-full px-2 py-0.5 border-b-[1px] border-[#525252] bg-red-90 text-zinc-300 text-sm">
              About
            </div>

            <div className="w-full text-white leading-5 text-[14px] py-2 font-semibold">
              I’m a frontend developer who enjoys building websites with React.
              I like solving problems, designing clean layouts, and continuously
              learning to become better at what I do.
            </div>
          </div>
          ...
          {/* Box 3 Location  */}
          <div
            //for Firefox backdrop-blur issue
            style={{
            ...
            className="relative border z-0 border-[#525252] rounded-lg lg:rounded-xl bg-[#1e1e1e] overflow-hidden group 
       ...
       "
          >
            ...
            {/* Status bar */}
            <div className="z-30 relative backdrop-blur-2xl w-full border-b border-[#525252] text-zinc-300 flex justify-between px-2 bg-[#1817174d] ">
            ...
            <div className="india z-20 bg-red-90 text-zinc-300 font-semibold p-3 relative">
              India
            </div>
          </div>
          ...
          {/* Box 4  skills */}
          <div
            className=" col-span-2 row-span-2 sm:order-6 sm:col-span-2 lg:order-4 border border-[#525252] rounded-lg lg:rounded-xl bg-[#1e1e1e] sm:overflow-y-scroll scrollbar-hide px-2 md:bg-none
        // mobile
        overflow-hidden
          relative
        "
  ...
  sm:hidden pointer-events-none"
            ...
            <Link to="/viewallskills">
              <div className="absolute bottom-4 left-0 w-full flex justify-center sm:hidden z-20   ">
                <button
                  className="px-3 py-1.5 text-xs border border-zinc-400   
    text-zinc-200 rounded-full flex items-center gap-1.5
    backdrop-blur-sm bg-black/40
       "
                >
                  <span className="tracking-tight ">View More</span>
          ...
          <div
            className="col-span-2 row-span-4 sm:col-span-4 md:col-span-4 lg:col-span-4 row-span-2 lg:row-span-3 sm:order-4 border border-[#525252] rounded-lg lg:rounded-xl bg-[#1e1e1e]  sm:overflow-y-scroll scrollbar-hide px-2 flex flex-col 
        // mobile
          relative 
          overflow-hidden
        "
          >
            <div
              className="absolute bottom-0 left-0 w-full h-28   z-25
   bg-gradient-to-t from-[#131313] via-[#161616a8] to-transparent
  sm:hidden pointer-events-none"
            ></div>
    ...
    backdrop-blur-sm bg-black/40
       "
                >
                  <button className="tracking-tight">View More</button>
