...
export function Project() {
  const cardsData = [
     {
      ...
      title: 'Sportech',
      description:
        "Sportech is a sleek showcase website for a modern garage, highlighting its work, services, and features. Get a glimpse of the team's expertise, past projects, and what makes Sportech the go-to garage for car enthusiasts.",
    ...
    },
    {
      ...
      description:
        'A responsive e-commerce web application with product listings, cart management, and a streamlined checkout flow. Built with a focus on performance, clean UI, and intuitive user experience.',
  ...
  return (
    <>
      <div className="w-full px-2 py-1 text-sm border-b-[1px] border-[#525252] bg-red-90 text-zinc-300 ">
        Projects
      </div>

      <div className="bg- grid sm:grid-cols-2 grid-cols-1 py-2 md:p-3">
        {cardsData.map((card) => (
          // <Card
          //   key={card.id}
          //   title={card.title}
